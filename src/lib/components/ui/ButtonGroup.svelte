...
<div class="flex flex-col gap-2 {className}">
	<div class="flex flex-col sm:flex-row gap-2">
		<div class="flex-1 flex flex-col gap-1">
			...
			{#if showLinks}
				<a href="/home#features" class="hidden sm:flex items-center gap-1 text-xs text-neutral-400 hover:text-neutral-300 transition-colors px-1 mt-1">
	...
	{#if showLinks}
		<a href="/home#features" class="flex sm:hidden items-center gap-1 text-sm text-neutral-400 hover:text-neutral-300 transition-colors px-1 mt-3">
			<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
				<circle cx="12" cy="12" r="10"/>
				<path d="M12 16v-4"/>
				<path d="M12 8h.01"/>
